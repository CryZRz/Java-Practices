...
public class ClienteDaoJDBC {
    ...
    private static final String SQL_SELECT = "SELECT id, nombre, apellido, email, telefono, saldo FROM cliente ORDER BY id DESC";
    private static final String SQL_SELECT_BY_ID = "SELECT id, nombre, apellido, email, telefono, saldo FROM cliente WHERE id = ?";
