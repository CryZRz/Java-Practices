...
<html>
    ...
    <body>
        ...
        <s:form>
            ...
            <s:textfield key="form.no.calle" name="personas.domicilio.numeroCalle" />
            <s:textfield key="form.pais" name="personas.domicilio.pais" />
            <s:submit value="form.enviar"/>
        </s:form>
        ...
        |
        <s:a href="%{localeES}"><s:text name="form.idioma.ingles"/></s:a>
