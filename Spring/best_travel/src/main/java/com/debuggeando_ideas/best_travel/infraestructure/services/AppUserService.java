...
import com.debuggeando_ideas.best_travel.domain.entities.repositories.mongo.AppUserRepository;
...
public class AppUserService implements ModifyUserService, UserDetailsService {
    ...
    public Map<String, Set<String>> addRole(String role, String username) {
        ...
        log.info("user {} with add role {}", userSaved.getUsername(), userSaved.getRole().getGrantedAuthorities().toString());
    ...
    public Map<String, Set<String>> removeRole(String role, String username) {
        ...
        log.info("user {} with remove role {}", userSaved.getUsername(), userSaved.getRole().getGrantedAuthorities().toString());
        return Collections.singletonMap(userSaved.getUsername(), authorities);
    }
