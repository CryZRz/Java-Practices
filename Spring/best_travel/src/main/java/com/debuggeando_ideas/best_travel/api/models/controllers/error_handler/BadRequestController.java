...
public class BadRequestController {
    ...
    public BaseErrorResponse handlerIdNotFound(RuntimeException exception){
    ...
    public BaseErrorResponse handlerIdNotFound(MethodArgumentNotValidException exception){
