...
import com.debuggeando_ideas.best_travel.domain.entities.repositories.jpa.ReservationRepository;
import com.debuggeando_ideas.best_travel.infraestructure.abstract_services.IReservationService;
import com.debuggeando_ideas.best_travel.infraestructure.helper.*;
...
public class ReservationService implements IReservationService {
    ...
    public ReservationResponse create(ReservationRequest request) {
        ...
        var hotel = hotelRepositrory.findById(request.getIdHotel()).orElseThrow(() -> new IdNotFoundException(Tables.hotel.name()));
        ...
        var reservationToPersist = ReservationEntity.builder()
                ...
                .price(hotel.getPrice().add(charger_price_percentage))
                .build();
    ...
    public ReservationResponse update(ReservationRequest request, UUID uuid) {
        ...
        var reservationPersisted = reservationRepository.save(reservationToUpdate);
    ...
    public BigDecimal findPrice(Long hotelId, Currency currency) {
        ...
        var currencyDTO = this.apiCurrencyConectorHelper.currency(currency);
